...
$(".pipDrop1").hover(function() {
    $("#navbarDropdownx").click();
}, function() {
    $(".pipDrop1").click();
});

$(".pipDrop2").hover(function() {
    $("#navbarDropdownxx").click();
}, function() {
    $(".pipDrop2").click();
});

$(".pipDrop3").hover(function() {
    $("#navbarDropdownxxx").click();
}, function() {
    $(".pipDrop3").click();
});
...
! function(e) {
    e.simpleTicker = function(t, i) {
        ...
        e(t), t = t;
        c.init = function() {
            switch (c.settings = e.extend({}, s, i), n.ul = t.children("ul"), n.li = t.find("li"), n.initList = t.find("li:first"), n.ulWidth = n.ul.width(), n.liHeight = n.li.height(), t.css({ height: n.liHeight }), n.li.css({ top: "0", left: "0", position: "absolute" }), c.settings.effectType) {
                case "fade":
                    c.effect.fade();
                    break;
                case "roll":
...
! function(e, t, n, a) {
    ...
    function s(t, n) { this.element = t, this._name = i, this._defaults = e.fn.SimpleMarquee.defaults, this.settings = e.extend({}, this._defaults, n), this.marqueeSpawned = [], this.marqueeHovered = !1, this.documentHasFocus = !1, this.counter = 0, this.timeLeft = 0, this.currentPos = 0, this.distanceLeft = 0, this.totalDistance = 0, this.contentWidth = 0, this.endPoint = 0, this.duration = 0, this.hovered = !1, this.padding = 0, this.init() }

    function r(e) { this.el = e, this.counter = 0, this.name = "", this.timeTop = 0, this.currentPos = 0, this.distanceTop = 0, this.totalDistance = 0, this.contentWidth = 0, this.endPoint = 0, this.duration = 0, this.hovered = !1, this.padding = 0 }
    e.extend(s.prototype, {
        ...
        buildCache: function() { this.$element = e(this.element) },
        bindEvents: function() {
            var n = this;
            e(t).on("focus", function() { n.documentHasFocus = !0; for (var e in n.marqueeSpawned) n.marqueeManager(n.marqueeSpawned[e]) }), e(t).on("blur", function() { n.documentHasFocus = !1; for (var e in n.marqueeSpawned) n.marqueeSpawned[e].el.clearQueue().stop(), n.marqueeSpawned[e].hovered = !0 })
        },
        unbindEvents: function() { e(t).off("blur focus") },
        getPosition: function(t) { return this.currentPos = parseInt(e(t).css("left")), this.currentPos },
        createMarquee: function() {
            ...
            for (var d = -((o + a.padding) * c - s), l = s - d, m = 0; m < c; m++) {
                var h = !1;
                h = 1 == a.hover ? e('<div class="marquee-' + (m + 1) + '">' + i + "</div>").mouseenter(function() { if (1 == t.documentHasFocus && 0 == t.marqueeHovered) { t.marqueeHovered = !0; for (var e in t.marqueeSpawned) t.marqueeSpawned[e].el.clearQueue().stop(), t.marqueeSpawned[e].hovered = !0 } }).mouseleave(function() {
        ...
        marqueeAnim: function(e) {
            var t = this;
            e.counter++, e.el.clearQueue().animate({ left: e.endPoint + "px" }, e.timeLeft, "linear", function() { t.marqueeManager(e) })
        },
        callback: function() { var e = this.settings.onComplete; "function" == typeof e && e.call(this.element) }
    }), e.fn.SimpleMarquee = function(t) { return this.each(function() { e.data(this, "plugin_" + i) || e.data(this, "plugin_" + i, new s(this, t)) }), this }, e.fn.SimpleMarquee.defaults = { property: "value", onComplete: null, duration: 2e4, padding: 10, marquee_class: ".marquee", container_class: ".simple-marquee-container", sibling_class: 0, hover: !0 }
}(jQuery, window, document);