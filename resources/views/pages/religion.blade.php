...
@section('title', 'Religious books')

@section('content')
                        <div class="row margin-vert-30">
                            <!-- Main Column -->
                            <div class="col-md-9">
                                @foreach($religions as $child)
                                <!-- Blog Post -->
                                <div class="blog-post">
                                    <!-- Blog Item Header -->
                                    <div class="blog-item-header">
                                        ...
                                        <div class="blog-post-date pull-left">
                                            <span class="day">{{ date('j', strtotime($child->created_at)) }}</span>
                                            <span class="month">{{ date('M', strtotime($child->created_at)) }}</span>
                                        </div>
                                        <!-- End Date -->
                                        <!-- Title -->
                                        <h2>
                                    ...
                                    <div class="blog">
                                        ...
                                        <div class="blog-post-body row margin-top-15">
                                            <div class="col-md-5">
                                                <img class="pull-left" src="{{ asset('images/'.$child->image) }}" alt="thumb1">
                                            </div>
                                            <div class="col-md-7">
                                                <p>{{ substr(strip_tags($child->description), 0, 450) }}{{ strlen(strip_tags($child->description)) > 450 ? '...' : "" }}</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="blog-post-details-item blog-post-details-item-right pull-right">
                                                        <a href="{{ $child->id }}" class="btn btn-primary">
                                                            Read More
