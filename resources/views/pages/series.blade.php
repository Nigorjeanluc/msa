        ...
        <div class="blog-post">
            ...
            <div class="blog-item-header">
                ...
                <div class="blog-post-date pull-left">
                    <span class="day">{{ date('j', strtotime($serie->created_at)) }}</span>
                    <span class="month">{{ date('M', strtotime($serie->created_at)) }}</span>
                </div>
                <!-- End Date -->
                <!-- Title -->
                <h2>
            ...
            <div class="blog">
                ...
                <div class="blog-post-body row margin-top-15">
                    <div class="col-md-5">
                        <img class="pull-left" src="{{ asset('images/'.$serie->image) }}" alt="thumb1">
                    </div>
                    <div class="col-md-7">
                        <p>{{ substr(strip_tags($serie->description), 0, 450) }}{{ strlen(strip_tags($serie->description)) > 450 ? '...' : "" }}</p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="blog-post-details-item blog-post-details-item-right pull-right">
                                <a href="{{ route('seriesStories',$serie->id) }}" class="btn btn-primary">
                                    Read More
