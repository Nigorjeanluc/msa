...
@section('pageview')
      <h1>
        Control board
        <small>Edit {{ ucfirst($post->name)."'s" }} account</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Control</a></li>
        <li class="active">Edit {{ ucfirst($post->name)."'s" }} account</li>
      </ol>
@endsection
...
<div class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="box box-info">
            ...
            <h3 class="box-title">Edit about admin here!</h3>
            ...
            <div class="box-body">
                {!! Form::model($post, ['route' => ['admin.admins.update', $post->id], 'method' => 'PUT', 'data-parsley-validate' => 'true', 'files' => true]) !!}
                    <!-- text input -->
