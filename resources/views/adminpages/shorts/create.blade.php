...
@section('title', 'Add a new short story')


@section('pageview')
      <h1>
        Control board
        <small>Add a new short story</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Control</a></li>
        <li class="active">Add a new short story</li>
      </ol>
@endsection
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Add a new short story here!</h3>
            ...
            <div class="box-body">
                {!! Form::open(['route' => 'shorts.store', 'data-parsley-validate' => 'true', 'files' => true]) !!}
                    <!-- text input -->
                    <div class="form-group">
                      {{ Form::label('title', 'Short story title') }}
