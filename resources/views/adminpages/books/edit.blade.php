...
@section('pageview')
      <h1>
        Control board
        <small>Edit {{ ucfirst($post->title) }} book</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Control</a></li>
        <li class="active">Edit {{ ucfirst($post->title) }} book</li>
      </ol>
@endsection
...
<div class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="box box-info">
            ...
            <h3 class="box-title">Edit about book here!</h3>
            ...
            <div class="box-body">
                {!! Form::model($post, ['route' => ['books.update', $post->id], 'method' => 'PUT', 'data-parsley-validate' => 'true', 'files' => true]) !!}
                <!-- text input -->
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        @for($year = $post->year; $year < 2070; $year++)
            ...
            <div class="box-footer">
                    {{ Form::submit('Submit Changes', ['class' => 'btn btn-info btn-md btn-block'])}}
