        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('room1') }}"><i class="fa fa-adjust"></i> Room 1</a></li>
                <li><a href="{{ route('room2') }}"><i class="fa fa-adjust"></i> Room 2</a></li>
                <li><a href="{{ route('room3') }}"><i class="fa fa-adjust"></i> Room 3</a></li>
              </ul>
            </li>
            <!--
            <li class="treeview">
